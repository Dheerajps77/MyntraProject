...
public class EMAIL {
	...
	public static void SendEmailNow(String hostName, String portID, String senderEmailID, String senderPassword, String [] receiverEmailArray, String [] ccEmailArray,long pageLoadTime_Minutes, String reportPath) {
        ...
        String subject = "DK PARTNER PHASE 1 AUTOMATION STATUS";
        StringBuffer body = new StringBuffer("Hi All, <br> <br>  <b> NOTE: THIS IS AUTOMATED EMAIL</b><br> <br>Please find attached file <b>MAGIC_DK_PARTNER_PHASE1_AUTOMATION_REPORT.html</b> for the complete status of Phase 1 Automation. You need to Download the file to view it.<br> <br>");
        body.append("Failed scenarios are attached in the email(if any)");
